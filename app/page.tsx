...
import { ArrowRight, Star, ShoppingBag, Percent, ShieldCheck, Zap } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 text-center lg:text-left">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-tight">
                Refine Your Sound &amp; Style.
              </h1>
              <p className="text-base sm:text-lg text-neutral-300 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                Discover the new Sony WH-1000XM5 headphones with industry-leading active noise cancellation. Pure acoustic bliss starts here.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link href="/products/sony-wh1000xm5-wireless-headphones">
            ...
            <div className="relative aspect-[4/3] w-full max-w-lg mx-auto overflow-hidden rounded-3xl bg-neutral-800 border border-neutral-700 p-2 shadow-2xl flex items-center justify-center">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-neutral-900/90 backdrop-blur-md border border-neutral-700 rounded-2xl p-4 flex justify-between items-center gap-4 shadow-xl">
                <div>
                  <h4 className="text-sm font-bold text-white">WH-1000XM5 Noise Cancelling</h4>
                  <p className="text-xs text-neutral-400 mt-0.5">Sony • Active Ambient Control</p>
                </div>
                <div className="text-right shrink-0">
                  <span className="text-lg font-extrabold text-primary-400">$349.99</span>
                  <p className="text-[10px] text-neutral-500 line-through">$399.99</p>
                </div>
              </div>
            </div>
        ...
        <div className="rounded-3xl bg-neutral-100 p-8 sm:p-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left border">
          <div className="space-y-3">
            ...
            <p className="text-sm text-neutral-500 leading-relaxed">
              Order in seconds with our optimized multi-step checkout checkout experience. Easy, fast, secure.
            </p>
          </div>
          <div className="space-y-3">
            <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-primary-600 mx-auto md:mx-0 shadow-sm">
